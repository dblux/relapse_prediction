...
ax1.set_ylabel("p")
ax1.set_title("{}: LogReg - Likelihood ratios {}".format(SUBTYPE, list(X)))
fig1.savefig("dump/{}_lr{}-proba.pdf".format(SUBTYPE, ARG1))

fig2, ax2 = plt.subplots(1,1)
ax2.scatter(mrd, proba1[:,1], c=lab_col)
ax2.set_xlabel("log10(D33_MRD)")
ax2.set_ylabel("p")
ax2.set_title("{}: LogReg - Features {}".format(SUBTYPE, list(X)))
fig2.savefig("dump/{}_features{}-proba.pdf".format(SUBTYPE, ARG1))
...
mrd33 = csquantile_features.iloc[:,14:16]
